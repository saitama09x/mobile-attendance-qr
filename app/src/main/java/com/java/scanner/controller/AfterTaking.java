...
public class AfterTaking extends AppCompatActivity {
...
setContentView(R.layout.aftertaking);
...
public void edit_remarks(View view){
final Dialog dialog = new Dialog(this);
final TextView update_remarks = (TextView) this.findViewById(R.id.remarks);
dialog.setContentView(R.layout.remarks_dialog);  
final EditText remarks_text = (EditText) dialog.findViewById(R.id.remarks);
remarks_text.setText(update_remarks.getText().toString());
Button rem_btn = (Button) dialog.findViewById(R.id.button);
rem_btn.setOnClickListener(new View.OnClickListener() {
@Override
public void onClick(View v) {
sqlite.insertRemarks(ids, remarks_text.getText().toString());
update_remarks.setText(remarks_text.getText().toString());
dialog.dismiss();
}
});
dialog.show();
