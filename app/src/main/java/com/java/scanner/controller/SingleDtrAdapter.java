...
public class SingleDtrAdapter extends ArrayAdapter<String>{
...
public SingleDtrAdapter(Context context, String[] emp_name, String[] emp_id,
	String[] date_created, String[] time_created, 
	String[] check, Integer[] ids, Integer[] sync_status, String[] project_name) {
...
public View getView(int position, View view, ViewGroup parent) {
	...
	TextView project_name_ = (TextView) rowView.findViewById(R.id.project_name);
	...
	click_line.setOnClickListener(new View.OnClickListener() {
		public void onClick(View view){				
			...
			Time_attendance.view_type = "view_check";			
...
*/
	...
	project_name_.setText("Project: " + project_name[position]);
	return rowView;
