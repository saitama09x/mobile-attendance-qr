...
public class DatePickerAdapter extends ArrayAdapter<String>{

	private Activity activity;
    private List date;
    LayoutInflater inflater;
    private Monthly_class month;

    public DatePickerAdapter(Context con, int textViewResourceId, List date) 
     {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
         ...
         month = (Monthly_class) date.get(position);
